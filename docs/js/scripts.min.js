(function() {
  function h(c) {
    c = c.target;
    const a = c.childNodes.length;
    if (c.localName !== "button" || !a)
      return c.classList.contains("rippleJS") ? c : null;
    for (let b = 0; b < a; ++b) {
      const g = c.childNodes[b];
  ...
  function n(c, a) {
    ...
    if (b) {
      ...
      let e = b.getAttribute("data-event");
      if (!e || e === c) {
        ...
        void 0 !== e
          ? (a = a.offsetY)
          : ((e = a.clientX - d.left), (a = a.clientY - d.top));
        const f = document.createElement("div");
        d =
          d.width === d.height
            ? 1.412 * d.width
            : Math.sqrt(d.width * d.width + d.height * d.height);
        const k = `${2 * d}px`;
        f.style.width = k;
        f.style.height = k;
        ...
        const l = c === "mousedown" ? "mouseup" : "touchend";
        ...
        var m = function() {
          ...
          window.setTimeout(() => {
            b.removeChild(f);
            b.children.length ||
              (g.remove("active"), b.removeAttribute("data-event"));
          }, 650);
        };
  ...
  function p() {
    ...
    c.addEventListener(
      "touchstart",
      a => {
        for (let b = 0; b < a.changedTouches.length; ++b)
          n(a.type, a.changedTouches[b]);
      },
      { passive: !0 }
    );
  }
  (function() {
    function c() {
      ...
      const b = window.getComputedStyle(a).position === "absolute";
...
!(function(e, t) {
  typeof define === "function" && define.amd
    ? define(["exports"], t)
    : t(typeof exports !== "undefined" ? exports : (e.microlight = {}));
})(this, e => {
  let t;
  ...
  const p = function(e) {
    for (n = r.getElementsByClassName(e || "microlight"), t = 0; (i = n[t++]); )
      for (
        var p,
          h,
          g,
            ...
            k &&
              (i[a]((y = r.createElement("span"))).setAttribute(
                ...
                [
                  ...
                  `${s + 6 + c + d + 7 + E + S / 4}),${d}${3}${E}${S / 4}${f}`,
                  `${s + 7 + c + u + E + S / 5}),-${u}${E}${S / 5}${f}`,
                  `font-style:italic;${s}${5}${c}${u}${E}${S /
                    4}),-${u}${E}${S / 4}${f}`
                ][
                  C
                    ? C < 3
...
!(function(e, t) {
    ...
    return (
      ...
      t.length === 1 && r.nodeType === 1
        ? w.find.matchesSelector(r, e)
          ? [r]
          : []
        : w.find.matches(e, w.grep(t, e => e.nodeType === 1))
    );
  }),
    w.fn.extend({
      find(e) {
      ...
      if (t)
        return `${parseFloat(Fe(e, "marginLeft")) ||
          e.getBoundingClientRect().left -
            se(e, { marginLeft: 0 }, () => e.getBoundingClientRect().left)}px`;
    })),
  ...
  w.fn.extend({
    ...
    hasClass(e) {
      ...
      t = ` ${e} `;
      while ((n = this[r++]))
        if (n.nodeType === 1 && ` ${vt(mt(n))} `.indexOf(t) > -1) return !0;
      return !1;
    }
  });
  const bt = /\r/g;
...
!(function(e, t) {
  ...
  const y = { type: !0, src: !0, noModule: !0 };
  function m(e, t, n) {
    let i;
  ...
  (w.fn = w.prototype = {
    ...
    (w.extend = w.fn.extend = function() {
      ...
      let l = !1;
      for (
        typeof a === "boolean" && ((l = a), (a = arguments[u] || {}), u++),
          typeof a === "object" || g(a) || (a = {}),
          u === s && ((a = this), u--);
        u < s;
        u++
    ...
    w.extend({
      ...
      map(e, t, n) {
        ...
        if (T(e))
          for (r = e.length; o < r; o++)
            (i = t(e[o], o, n)) != null && u.push(i);
        else for (o in e) (i = t(e[o], o, n)) != null && u.push(i);
        return a.apply([], u);
      },
      guid: 1,
      support: h
  ...
  const E = (function(e) {
    ...
    const $ = new RegExp(`^${I}+|((?:^|[^\\\\])(?:\\\\.)*)${I}+$`, "g");

    const F = new RegExp(`^${I}*,${I}*`);

    const z = new RegExp(`^${I}*([>+~]|${I})${I}*`);

    const _ = new RegExp(`=${I}*([^\\]'"]*?)${I}*\\]`, "g");
    ...
    const X = {
      ...
      PSEUDO: new RegExp(`^${M}`),
      CHILD: new RegExp(
        `^:(only|first|last|nth|nth-last)-(child|of-type)(?:\\(${I}*(even|odd|(([+-]|)(\\d*)n|)${I}*(?:([+-]|)${I}*(\\d+)|))${I}*\\)|)`,
        "i"
      ),
      bool: new RegExp(`^(?:${H})$`, "i"),
      needsContext: new RegExp(
    ...
    const Z = new RegExp(`\\\\([\\da-f]{1,6}${I}?|(${I})|.)`, "ig");
    ...
    function oe(e, t, r, i) {
      ...
      const C = t ? t.nodeType : 9;
      if (
        ((r = r || []),
        typeof e !== "string" || !e || (C !== 1 && C !== 9 && C !== 11))
      )
        return r;
      if (
        !i &&
          ...
          CHILD(e, t, n, r, i) {
            ...
            return r === 1 && i === 0
              ...
              : function(t, n, s) {
                  ...
                  const y = u && t.nodeName.toLowerCase();
    ...
    function we(e, t, n, r, i) {
      for (var o, a = [], u = 0, s = e.length, l = t != null; u < s; u++)
    ...
    function Ce(e, t, n, r, i, o) {
      return (
        ...
        ue((o, a, u, s) => {
          ...
          const g = o || xe(t || "*", u.nodeType ? [u] : u, []);

          const v = !e || (!o && t) ? g : we(g, d, e, u, s);

          let y = n ? (i || (o ? e : h || r) ? [] : a) : v;
          if ((n && n(v, y, u, s), r)) {
    ...
    function Ee(e, t) {
      ...
      const o = function(o, a, u, s, c) {
        ...
        const T = o || (i && r.find.TAG("*", c));

        const E = (C += w == null ? 1 : Math.random() || 0.1);

        const N = T.length;
        for (c && (l = a === p || a || c); m !== N && (f = T[m]) != null; m++) {
          if (i && f) {
    ...
    return (
      ...
      d(),
      (n.sortDetached = se(
        e => 1 & e.compareDocumentPosition(p.createElement("fieldset"))
      )),
      se(
        e => (
          (e.innerHTML = "<a href='#'></a>"),
      ...
      se(e => e.getAttribute("disabled") == null) ||
        le(H, (e, t, n) => {
          let r;
          if (!n)
            return !0 === e[t]
  ...
  const A = w.expr.match.needsContext;
  function D(e, t) {
    return e.nodeName && e.nodeName.toLowerCase() === t.toLowerCase();
  }
  const S = /^<([a-z][^\/\0>:\x20\t\r\n\f]*)[\x20\t\r\n\f]*\/?>(?:<\/\1>|)$/i;
  ...
  (w.filter = function(e, t, n) {
    ...
    w.fn.extend({
      ...
      is(e) {
        return !!L(
          this,
          typeof e === "string" && A.test(e) ? w(e) : e || [],
          !1
        ).length;
      }
    });
  ...
  ((w.fn.init = function(e, t, n) {
    ...
    (j = w(r));
  const O = /^(?:parents|prev(?:Until|All))/;
    ...
    w.fn.extend({
      data(e, t) {
        ...
        if (void 0 === e) {
          if (
            this.length &&
            ((i = J.get(o)), o.nodeType === 1 && !K.get(o, "hasDataAttrs"))
          ) {
            n = a.length;
            while (n--)
              a[n] &&
  ...
  function se(e, t, n, r) {
    ...
    let c = (w.cssNumber[t] || (l !== "px" && +s)) && ie.exec(w.css(e, t));
    if (c && c[3] !== l) {
      (s /= 2), (l = l || c[3]), (c = +s || 1);
      while (a--)
        w.style(e, t, c + l),
      ...
      (r = e[o]).style &&
        ...
        t
          ? (n === "none" &&
              ...
              i[o] || (r.style.display = "")),
            r.style.display === "" && ae(r) && (i[o] = ce(r)))
          : n !== "none" && ((i[o] = "none"), K.set(r, "display", n)));
    for (o = 0; o < a; o++) i[o] != null && (e[o].style.display = i[o]);
    return e;
  }
  w.fn.extend({
  ...
  function be(e, t, n, r, i) {
    for (
      ...
      if ((o = e[p]) || o === 0)
        if (b(o) === "object") w.merge(d, o.nodeType ? [o] : o);
        else if (me.test(o)) {
          (a = a || f.appendChild(t.createElement("div"))),
  ...
  (w.event = {
    ...
    dispatch(e) {
      ...
      const l = (K.get(this, "events") || {})[t.type] || [];
    ...
    special: {
      ...
      click: {
        trigger() {
          if (this.type === "checkbox" && this.click && D(this, "input"))
            return this.click(), !1;
        },
        _default(e) {
          return D(e.target, "a");
  ...
  const Se = /<script|<style|<link/i;

  const Le = /checked\s*(?:[^=]|=\s*.checked.)/i;

  const je = /^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g;
  function qe(e, t) {
    return D(e, "table") && D(t.nodeType !== 11 ? t : t.firstChild, "tr")
      ? w(e).children("tbody")[0] || e
      : e;
  }
  function Oe(e) {
  ...
  function Re(e, t, n, r) {
    ...
    const y = g(v);
    if (y || (d > 1 && typeof v === "string" && !h.checkClone && Le.test(v)))
      return e.each(function(i) {
        const o = e.eq(i);
  ...
  function Be(e, t, n) {
    for (var r, i = t ? w.filter(t, e) : e, o = 0; (r = i[o]) != null; o++)
      n || r.nodeType !== 1 || w.cleanData(ve(r)),
        r.parentNode &&
  ...
  w.extend({
    ...
    clone(e, t, n) {
      ...
      const s = w.contains(e.ownerDocument, e);
      if (
        !(
          h.noCloneChecked ||
          (e.nodeType !== 1 && e.nodeType !== 11) ||
    ...
    w.fn.extend({
      ...
      empty() {
        for (var e, t = 0; (e = this[t]) != null; t++)
          e.nodeType === 1 && (w.cleanData(ve(e, !1)), (e.textContent = ""));
        return this;
      },
      clone(e, t) {
        return (
  ...
  const Me = new RegExp(`^(${re})(?!px)[a-z%]+$`, "i");
  ...
  function Ze(e, t, n, r, i, o) {
    ...
    if (n === (r ? "border" : "content")) return 0;
    for (; a < 4; a += 2)
      n === "margin" && (s += w.css(e, n + oe[a], !0, i)),
        r
          ? (n === "content" && (s -= w.css(e, `padding${oe[a]}`, !0, i)),
            n !== "margin" && (s -= w.css(e, `border${oe[a]}Width`, !0, i)))
  ...
  w.extend({
    ...
    (w.cssHooks.marginLeft = ze(h.reliableMarginLeft, (e, t) => {
      if (t)
        return `${parseFloat(Fe(e, "marginLeft")) ||
          e.getBoundingClientRect().left -
            ue(e, { marginLeft: 0 }, () => e.getBoundingClientRect().left)}px`;
    })),
    w.each({ margin: "", padding: "", border: "Width" }, (e, t) => {
      (w.cssHooks[e + t] = {
        expand(n) {
        ...
        e !== "margin" && (w.cssHooks[e + t].set = Je);
    }),
    w.fn.extend({
      css(e, t) {
        return _(
  ...
  w.fn.extend({
    ...
    w.extend({
      ...
      attrHooks: {
        type: {
          set(e, t) {
            if (!h.radioValue && t === "radio" && D(e, "input")) {
              const n = e.value;
              return e.setAttribute("type", t), n && (e.value = n), t;
            }
          }
  ...
  const rt = /^(?:input|select|textarea|button)$/i;
      ...
      return typeof t === "boolean" && r
        ...
        : this.each(function() {
            ...
            if (r) {
              ...
              while ((t = a[i++]))
                o.hasClass(t) ? o.removeClass(t) : o.addClass(t);
            } else (void 0 !== e && n !== "boolean") || ((t = at(this)) && K.set(this, "__className__", t), this.setAttribute && this.setAttribute("class", t || !1 === e ? "" : K.get(this, "__className__") || ""));
          });
    },
    hasClass(e) {
      let t;
      ...
      t = ` ${e} `;
      while ((n = this[r++]))
        if (n.nodeType === 1 && ` ${ot(at(n))} `.indexOf(t) > -1) return !0;
      return !1;
    }
  });
  const st = /\r/g;
  w.fn.extend({
    ...
    (h.focusin = "onfocusin" in e);
  const lt = /^(?:focusinfocus|focusoutblur)$/;
  ...
  w.extend(w.event, {
    trigger(t, n, i, o) {
      ...
      let b = f.call(t, "namespace") ? t.namespace.split(".") : [];
      if (
        ((u = h = s = i = i || r),
        i.nodeType !== 3 &&
          i.nodeType !== 8 &&
      ...
      w.each({ focus: "focusin", blur: "focusout" }, (e, t) => {
        ...
        w.event.special[t] = {
          setup() {
            ...
            const i = K.access(r, t);
            i || r.addEventListener(e, n, !0), K.access(r, t, (i || 0) + 1);
          },
          teardown() {
            const r = this.ownerDocument || this;

            const i = K.access(r, t) - 1;
            i
              ? K.access(r, t, i)
  ...
  const ht = /^(?:input|select|textarea|keygen)/i;
  function gt(e, t, n, r) {
    let i;
    if (Array.isArray(t))
      w.each(t, (t, i) => {
        n || ft.test(e)
          ? r(e, i)
          : gt(`${e}[${typeof i === "object" && i != null ? t : ""}]`, i, n, r);
      });
  ...
  (w.param = function(e, t) {
    ...
    (w.offset = {
      setOffset(e, t, n) {
        ...
        c === "static" && (e.style.position = "relative"),
          ...
          (s = w.css(e, "left")),
          (l =
            (c === "absolute" || c === "fixed") && (o + s).indexOf("auto") > -1)
            ? ((a = (r = f.position()).top), (i = r.left))
            : ((a = parseFloat(o) || 0), (i = parseFloat(s) || 0)),
          g(t) && (t = t.call(e, n, w.extend({}, u))),
          t.top != null && (d.top = t.top - u.top + a),
          t.left != null && (d.left = t.left - u.left + i),
      ...
      w.fn[e] = function(r) {
        return _(
          ...
          (e, r, i) => {
            let o;
            if (
              (v(e) ? (o = e) : e.nodeType === 9 && (o = e.defaultView),
              void 0 === i)
            )
              return o ? o[t] : e[r];
            o
    ...
    w.each(["top", "left"], (e, t) => {
      w.cssHooks[t] = ze(h.pixelPosition, (e, n) => {
        if (n)
    ...
    w.each({ Height: "height", Width: "width" }, (e, t) => {
      w.each({ padding: `inner${e}`, content: t, "": `outer${e}` }, (n, r) => {
        w.fn[r] = function(i, o) {
          ...
          const u = n || (!0 === i || !0 === o ? "margin" : "border");
          return _(
            this,
            (t, n, i) => {
              let o;
...
$(document).ready(() => {
  ...
  // --------Speed dial------
  $(".tk-speed-dial__button").on("click", () => {
    $(".tk-speed-dial ul").slideToggle();
    $(".tk-speed-dial__item").on("click", () => {
  ...
  document.querySelector(".toast-examples > button").onclick = function() {
    const toast = document.querySelector(".toast-examples > .tk-toast");
  ...
  // --------modal dialog------
  const modal = document.querySelector('[data-modal="dialog"]');
  const btn = document.querySelector('[data-onclick="dialog"]');
  ...
  window.onscroll = function() {
    const curentScrollPos = window.pageYOffset;
